...
## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/availability_icon.png?raw=true) Availability 
...
![calendar](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/availability_calendar.jpg?raw=true)
...
## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/current_loc_icon.png?raw=true) Current Lat/Long
...
## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/flight_notice_icon.png?raw=true) Flight Notice
...
![event](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/flight_notice_example_1.png?raw=true)

Choose the appropriate flight

![flight](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/flight_notice_example_2.png?raw=true)
...
![text_msg](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/flight_notice_example_3.png?raw=true)

***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/loan_icon.png?raw=true) Loan Calculator
...
![shortcut](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/on_my_way.jpg?raw=true)

***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/pack_icon.png?raw=true) Packing List (Item Select)
...
![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/pack_folder.png?raw=true)
...
![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/pack_example.png?raw=true)

***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/timestamp_icon.png?raw=true) Timestamp to Clipboard
...
## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/tip_calc_icon.png?raw=true) Tip Calculator
...
![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/tip_example.jpeg?raw=true)

***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/today_icon.png?raw=true) Today
...
![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/today_example.jpeg?raw=true)


***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/vcard_icon.png?raw=true) VCARD QR
...
![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/vcard_menu.jpeg?raw=true)

and have your acquaintence/friend point their camera at the resulting QR code and then save the contact.

![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/vcard_example.jpg?raw=true)


***

## ![icon](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/wifi_icon.png?raw=true) Wifi QR
...
![example](https://github.com/woodwerk/iOS_Shortcuts/blob/master/media/wifi_example.jpeg?raw=true)
